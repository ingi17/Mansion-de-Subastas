...
const connection = mongoose.createConnection('mongodb+srv://veft-mdb:passwordfordb@veft-1ycxq.gcp.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true });
